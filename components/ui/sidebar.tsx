...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "group/sidebar relative flex h-full w-full flex-col overflow-hidden border-r bg-background duration-300",
        className,
      )}
      {...props}
    />
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn("flex flex-col gap-2 px-2", className)} {...props} />,
)
